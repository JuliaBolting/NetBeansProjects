        ...
        while (executando) {
            ...
            switch (opcao) {
                ...
                case 5 -> {
                    ...
                    switch (forma) {
                        case 1 -> fp = FormaPagamento.DINHEIRO;
                        case 2 -> fp = FormaPagamento.DEBITO;
                        case 3 -> {
                    ...
                    if (fp != null) {
                        if(pedido.setFormaPagamento(fp, parcelas)) executando = false;
                    }
                }


                case 6 -> pedido.mostrarResumo();
